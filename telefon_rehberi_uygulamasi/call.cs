namespace telefon_rehber
    ...
    public class Rehber
	{
		...
		{
			// Varsayılan 5 kişi
			kisiler.Add(new Kisi("Ahmet", "Yılmaz", "1806538"));
			kisiler.Add(new Kisi("Mehmet", "Çetin", "1806537"));
			kisiler.Add(new Kisi("Ali", "Korkut", "1806536"));
			kisiler.Add(new Kisi("Hüseyin", "Bakır", "1806535"));
			kisiler.Add(new Kisi("Burak", "Yukarı", "1806534"));
		}
